...
int main() {
  ...
  // std::println("{0}",
  // std::is_copy_constructible_v<std::vector<Instruction>>);
  // std::println("{0}",
  // std::is_trivially_copy_constructible_v<std::vector<Instruction>>);
  // std::println("{0}",
  // std::is_default_constructible_v<std::vector<Instruction>>);
  ...
  //     [](const IntType& a) { std::println("Visiting IntType const ref...");
  //     },
  //     [](const IntType&& a) { std::println("Visiting IntType const RValue
  //     ref..."); },
  //     [](BoolType& a) { std::println("Visiting BoolType ref..."); },
  //     [](const BoolType& a) { std::println("Visiting BoolType const ref...");
  //     },
